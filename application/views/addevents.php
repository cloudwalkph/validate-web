	...
	<div class="col-md-12">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo form_open('events/addevents'); ?>
					<div class="row">
						<div class="col-md-3">Event Name:</div>
						<div class="col-md-9">
							<div class="inputer floating-label">
								<div class="input-wrapper">
									<input type="text" class="form-control" id="exampleInput1" name="e_name">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="inputer floating-label">
								<div class="input-wrapper">
									<input type="text" class="form-control" id="exampleInput1" name="e_jo">
				...
				<div class="row">
					...
					<div class="col-md-9">
						<div class="inputer floating-label">
							<div class="input-wrapper">
								<input type="text" class="form-control" id="exampleInput1" name="e_area">
								<label for="exampleInput1">Area</label>
							</div>
						</div>
					</div>
				</div>
				<div class="row">						<h3>Expiration:</h3>					</div>
					<div class="row">
						<div class="col-md-3">Pre Event:</div>
						<div class="col-md-9">
							<div class="row">
								<div class="col-md-1">
									Date:
									...
									<div class="control-group">
										<div class="controls">
											<div class="input-group">
												...
												<div class="inputer">
													<div class="input-wrapper">
														<input type="text" style="width: 200px" name="p_date" class="form-control bootstrap-daterangepicker-basic" value="03/18/2013" />
													</div>
												</div>
											</div>
										</div>
					...
					</div>					<div class="row">						<div class="col-md-3">Event Proper:</div>						<div class="col-md-9">							<div class="row">								<div class="col-md-1">									Date:								</div>								<div class="col-md-11">									<div class="control-group">										<div class="controls">											<div class="input-group">												<span class="input-group-addon"><i class="ion-android-calendar"></i></span>												<div class="inputer">													<div class="input-wrapper">														<input type="text" style="width: 200px" name="e_date" class="form-control bootstrap-daterangepicker-basic" value="03/18/2013" />													</div>												</div>											</div>										</div>									</div>								</div>							</div>							<div class="row">							</div>						</div>					</div>					<div class="row">						<div class="col-md-3">Post Event:</div>						<div class="col-md-9">							<div class="row">								<div class="col-md-1">									Date:								</div>								<div class="col-md-11">									<div class="control-group">										<div class="controls">											<div class="input-group">												<span class="input-group-addon"><i class="ion-android-calendar"></i></span>												<div class="inputer">													<div class="input-wrapper">														<input type="text" style="width: 200px" name="pe_date" class="form-control bootstrap-daterangepicker-basic" value="03/18/2013" />													</div>												</div>											</div>										</div>									</div>								</div>							</div>							<div class="row">							</div>						</div>					</div>
